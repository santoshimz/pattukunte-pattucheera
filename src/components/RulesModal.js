...
const RulesModal = ({ openRulesModal, setOpenRulesModal }) => {
  return (
    <Modal
      className="w-90 mx-auto border-2 dark:border-primary border-gray-300/50 rounded bg-slate-200 dark:bg-primary text-primary dark:text-secondary p-5 text-xl mt-56"
